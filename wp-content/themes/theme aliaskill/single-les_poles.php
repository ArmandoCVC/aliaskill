...
<section class="pole1">
    <div class="pole1__banniere" style="background-image:url('<?php the_field('pole_img'); ?>');   background-position: center; background-repeat: no-repeat; background-size: cover;">

        <div class="pole1__banniere_overlay">

            <div class="pole1__banniere_overlay_container">
                <h1 class="pole1__banniere_overlay_container_titre"> <?php the_title(); ?> </h1>

                <div class="pole1__banniere_overlay_container_box">
                    <div class="pole1__banniere_overlay_container_box_duree">
                        <div class="pole1__banniere_overlay_container_box_duree_icones1">
                        ...
                        <div class="pole1__banniere_overlay_container_box_duree_icones2">
                    ...
                    <div class="pole1__banniere_overlay_container_box_boutton">
                        <a href="<?php the_field('pole-contenue_lienboutton'); ?>"><?php the_field('pole-contenue_titre'); ?></a>
                    </div>
                </div>
...
<section class="pole2">
    ...
    <article class="pole2__article2">
        ...
        <div class="pole2__article2_container">
            ...
            <div class="pole2__article2_container_img">
                <img src="<?php the_field('pole-contenue_public_img'); ?> " alt="">
            </div>

            <div class="pole2__article2_container_textes">
                <h1><?php the_field('pole-contenue_public'); ?> </h1>
    ...
    <article class="pole2__article3">
        ...
        <div class="pole2__article3_container">
            ...
            <div class="pole2__article3_container_img">
    ...
    <article class="pole2__article4">
        ...
        <div class="pole2__article4_container">
            ...
            <div class="pole2__article4_container_img">
                <img src="<?php the_field('pole-contenue_paragraphe_img'); ?> " alt="">
            </div>

            <div class="pole2__article4_container_textes">
                <h1><?php the_field('pole-contenue_contenue'); ?> </h1>
                <p><?php the_field('pole-contenue_paragraphe_contenue'); ?> </p>
            </div>
    ...
    <article class="pole2__article5">
        ...
        <div class="pole2__article5_container">
            ...
            <div class="pole2__article5_container_img">
                <img src="<?php the_field('pole-contenue_evaluation_img'); ?> " alt="">
            </div>
        </div>
...
<section class="pole3">
    <div class="pole3__carre">
        <div class="pole3__carre_container">

            <div class="pole3__carre_container_avis">

                <div class="pole3__carre_container_avis_box1">

                    <div class="pole3__carre_container_avis_box1_logo">
                        <img src="<?php the_field('pole-contenue_avis_img'); ?>" alt="">
                    </div>
                    <div class="pole3__carre_container_avis_box1_nom-logo">
                        <h1><?php the_field('pole-contenue_avis_nomentreprise'); ?></h1>
                    </div>
                    <div class="pole3__carre_container_avis_box1_etoiles">
                ...
                <div class="pole3__carre_container_avis_box2">

                    <div class="pole3__carre_container_avis_box2_titre">
                        <h1>Avis des Clients</h1>
                    </div>
                    <div class="pole3__carre_container_avis_box2_description">
                        <p>
                        <h1><?php the_field('pole-contenue_avis_paragraphe'); ?></h1>
                        </p>
                    </div>
