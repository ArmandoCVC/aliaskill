...
<section class="equipe">
    <div class="equipe__container">
        ...
        <article class="equipe__container_article2"style="color: white;">
        ...
        <article class="equipe__container_article4" style="color: white;">
            <div class="equipe__container_article4_haut">
             
                <h1>

                    <?php the_field('equipe_article4_titre'); ?>
                </h1>
            </div>

            <div class="equipe__container_article4_bas">
                <p>
                    <?php the_field('equipe_article4_paragraphe'); ?>
                </p>
            </div>
        </article>

        
        <article class="equipe__container_article5">
            <div class="equipe__container_article5_haut">
                ...
                <h1>
                    ...
                    <?php the_field('equipe_article5_titre'); ?>
                </h1>
            </div>

            <div class="equipe__container_article5_bas">
                <p>
                    <?php the_field('equipe_article5_paragraphe'); ?>
                </p>
            </div>
        </article>
